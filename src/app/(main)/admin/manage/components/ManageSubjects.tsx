// src/app/admin/manage/components/ManageSubjects.tsx
'use client';
...
export default function ManageSubjects() {
  ...
  useEffect(() => {
    if (editingSubject) {
      ...
      setManagingFaculty(editingSubject.managingFaculty || '');
    } else {
      // Clear form khi không edit
      setName('');
      setCode('');
      setManagingFaculty('');
    }
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div>
        <h3 className="text-xl font-semibold mb-4">
          {editingSubject ? `Đang sửa: ${editingSubject.name}` : 'Thêm môn học mới'}
        </h3>
