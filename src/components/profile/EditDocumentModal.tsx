...
const documentTypes = ['Lecture Notes', 'Exam Paper', 'Solved Exercises', 'Tutorial', 'Other'];
const schoolYears = ['2024-2025', '2023-2024', '2022-2023', '2021-2022', 'Older'];

export default function EditDocumentModal({ isOpen, onClose, doc }: EditDocumentModalProps) {
